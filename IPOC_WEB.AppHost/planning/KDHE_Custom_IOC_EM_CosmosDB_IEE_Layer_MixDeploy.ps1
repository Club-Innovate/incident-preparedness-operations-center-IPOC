...
.EXAMPLE
  Local Emulator:
    .\KDHE_Custom_IOC_EM_CosmosDB_IEE_Layer_MixDeploy_Fixed.ps1 -DeploymentTarget Emulator -DatabaseName "kdhe-ioc-flexdata-local"

.EXAMPLE
  Azure:
    .\KDHE_Custom_IOC_EM_CosmosDB_IEE_Layer_MixDeploy_Fixed.ps1 -DeploymentTarget Azure `
...
$script:AuditLogPath = Join-Path $PSScriptRoot ("KDHE_Custom_IOC_EM_CosmosDB_IEE_Layer_MixDeploy_" + (Get-Date -Format "yyyyMMdd_HHmmss") + ".log")
