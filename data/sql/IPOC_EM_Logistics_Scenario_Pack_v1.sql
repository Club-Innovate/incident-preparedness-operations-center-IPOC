/*
File: IPOC_WEB.AppHost/planning/IPOC_Logistics_Scenario_Pack_v1.sql
...
Usage:
  ...
  sqlcmd -S <server> -d <db> -v ScenarioMode="SURGE" -i IPOC_Logistics_Scenario_Pack_v1.sql

Notes:
- Designed to run after IPOC_Logistics_Synthetic_Data.sql.
...
BEGIN
  RAISERROR('Synthetic baseline incident not found. Run IPOC_Logistics_Synthetic_Data.sql first.', 16, 1);
  ROLLBACK TRANSACTION;
  RETURN;
END;
