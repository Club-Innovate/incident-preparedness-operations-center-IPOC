# Endpoint Evidence - EV-ENDP-0022

- Evidence ID: EV-ENDP-0022
- Control ID: PRI-01
- Domain: Minimum Necessary / Data Minimization
- Artifact Name: Endpoint review evidence - POST /api/v1/beds/import/availability/fhir
...
## Endpoint
- Method/Path: POST /api/v1/beds/import/availability/fhir
...
- Source references: security-compliance/controls/endpoint-minimum-necessary-reviews.csv (EvidenceRef=EV-ENDP-0022); audit/tmp/_tmp_endpoint_matrix_generated.md
- Test evidence: Automated validation run RUN-2026-07-14-008; log: audits/test-evidence/008.md
