# Endpoint Evidence - EV-ENDP-0071

- Evidence ID: EV-ENDP-0071
- Control ID: PRI-01
- Domain: Minimum Necessary / Data Minimization
- Artifact Name: Endpoint review evidence - POST /api/v1/agent/chat/completions
...
## Endpoint
- Method/Path: POST /api/v1/agent/chat/completions
...
- Source references: security-compliance/controls/endpoint-minimum-necessary-reviews.csv (EvidenceRef=EV-ENDP-0071); audit/tmp/_tmp_endpoint_matrix_generated.md
- Test evidence: Automated validation run RUN-2026-07-14-B4-021; log: audits/test-evidence/batch4/021.md
