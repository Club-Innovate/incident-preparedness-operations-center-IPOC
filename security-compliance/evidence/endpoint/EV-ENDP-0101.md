# Endpoint Evidence - EV-ENDP-0101

- Evidence ID: EV-ENDP-0101
- Control ID: PRI-01
- Domain: Minimum Necessary / Data Minimization
- Artifact Name: Endpoint review evidence - GET /api/v1/incidents/{incidentId:long}
...
## Endpoint
- Method/Path: GET /api/v1/incidents/{incidentId:long}
...
- Source references: security-compliance/controls/endpoint-minimum-necessary-reviews.csv (EvidenceRef=EV-ENDP-0101); audit/tmp/_tmp_endpoint_matrix_generated.md
- Test evidence: Automated validation run RUN-2026-07-14-B5-025; log: audits/test-evidence/batch5/025.md
