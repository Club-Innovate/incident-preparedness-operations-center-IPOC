# Endpoint Evidence - EV-ENDP-0030

- Evidence ID: EV-ENDP-0030
- Control ID: PRI-01
- Domain: Minimum Necessary / Data Minimization
- Artifact Name: Endpoint review evidence - POST /api/v1/auth/audit/logout
...
## Endpoint
- Method/Path: POST /api/v1/auth/audit/logout
...
- Source references: security-compliance/controls/endpoint-minimum-necessary-reviews.csv (EvidenceRef=EV-ENDP-0030); audit/tmp/_tmp_endpoint_matrix_generated.md
- Test evidence: Automated validation run RUN-2026-07-14-B3-012; log: audits/test-evidence/batch3/012.md
