# Endpoint Evidence - EV-ENDP-0008

- Evidence ID: EV-ENDP-0008
- Control ID: PRI-01
- Domain: Minimum Necessary / Data Minimization
- Artifact Name: Endpoint review evidence - POST /api/v1/admin/ics-positions
...
## Endpoint
- Method/Path: POST /api/v1/admin/ics-positions
...
- Source references: security-compliance/controls/endpoint-minimum-necessary-reviews.csv (EvidenceRef=EV-ENDP-0008); audit/tmp/_tmp_endpoint_matrix_generated.md
- Test evidence: Automated validation run RUN-2026-07-14-B2-005; log: audits/test-evidence/batch2/005.md
