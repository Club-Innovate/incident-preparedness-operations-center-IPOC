# Endpoint Evidence - EV-ENDP-0082

- Evidence ID: EV-ENDP-0082
- Control ID: PRI-01
- Domain: Minimum Necessary / Data Minimization
- Artifact Name: Endpoint review evidence - POST /api/v1/incidents/
...
## Endpoint
- Method/Path: POST /api/v1/incidents/
...
- Source references: security-compliance/controls/endpoint-minimum-necessary-reviews.csv (EvidenceRef=EV-ENDP-0082); audit/tmp/_tmp_endpoint_matrix_generated.md
- Test evidence: Automated validation run RUN-2026-07-14-B5-005; log: audits/test-evidence/batch5/005.md
