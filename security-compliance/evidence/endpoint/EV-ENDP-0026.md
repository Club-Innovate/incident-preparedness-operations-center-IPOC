# Endpoint Evidence - EV-ENDP-0026

- Evidence ID: EV-ENDP-0026
- Control ID: PRI-01
- Domain: Minimum Necessary / Data Minimization
- Artifact Name: Endpoint review evidence - GET /api/v1/admin/streaming/status
...
## Endpoint
- Method/Path: GET /api/v1/admin/streaming/status
...
- Source references: security-compliance/controls/endpoint-minimum-necessary-reviews.csv (EvidenceRef=EV-ENDP-0026); audit/tmp/_tmp_endpoint_matrix_generated.md
- Test evidence: Automated validation run RUN-2026-07-14-B3-001; log: audits/test-evidence/batch3/001.md
