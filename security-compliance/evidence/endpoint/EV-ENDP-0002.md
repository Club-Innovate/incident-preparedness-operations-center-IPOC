# Endpoint Evidence - EV-ENDP-0002

- Evidence ID: EV-ENDP-0002
- Control ID: PRI-01
- Domain: Minimum Necessary / Data Minimization
- Artifact Name: Endpoint review evidence - POST /api/v1/admin/streaming/stop
...
## Endpoint
- Method/Path: POST /api/v1/admin/streaming/stop
...
- Source references: security-compliance/controls/endpoint-minimum-necessary-reviews.csv (EvidenceRef=EV-ENDP-0002); audit/tmp/_tmp_endpoint_matrix_generated.md
- Test evidence: Automated validation run RUN-2026-07-14-002; log: audits/test-evidence/002.md
