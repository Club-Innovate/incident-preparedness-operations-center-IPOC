# Endpoint Evidence - EV-ENDP-0029

- Evidence ID: EV-ENDP-0029
- Control ID: PRI-01
- Domain: Minimum Necessary / Data Minimization
- Artifact Name: Endpoint review evidence - POST /api/v1/auth/audit/login
...
## Endpoint
- Method/Path: POST /api/v1/auth/audit/login
...
- Source references: security-compliance/controls/endpoint-minimum-necessary-reviews.csv (EvidenceRef=EV-ENDP-0029); audit/tmp/_tmp_endpoint_matrix_generated.md
- Test evidence: Automated validation run RUN-2026-07-14-B3-011; log: audits/test-evidence/batch3/011.md
