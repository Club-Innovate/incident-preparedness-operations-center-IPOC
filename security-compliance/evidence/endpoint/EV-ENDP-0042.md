# Endpoint Evidence - EV-ENDP-0042

- Evidence ID: EV-ENDP-0042
- Control ID: PRI-01
- Domain: Minimum Necessary / Data Minimization
- Artifact Name: Endpoint review evidence - GET /api/v1/admin/locations
...
## Endpoint
- Method/Path: GET /api/v1/admin/locations
...
- Source references: security-compliance/controls/endpoint-minimum-necessary-reviews.csv (EvidenceRef=EV-ENDP-0042); audit/tmp/_tmp_endpoint_matrix_generated.md
- Test evidence: Automated validation run RUN-2026-07-14-B4-017; log: audits/test-evidence/batch4/017.md
