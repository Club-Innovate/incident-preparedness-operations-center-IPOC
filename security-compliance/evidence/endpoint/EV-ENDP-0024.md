# Endpoint Evidence - EV-ENDP-0024

- Evidence ID: EV-ENDP-0024
- Control ID: PRI-01
- Domain: Minimum Necessary / Data Minimization
- Artifact Name: Endpoint review evidence - POST /api/v1/resources/import/inventory/csv
...
## Endpoint
- Method/Path: POST /api/v1/resources/import/inventory/csv
...
- Source references: security-compliance/controls/endpoint-minimum-necessary-reviews.csv (EvidenceRef=EV-ENDP-0024); audit/tmp/_tmp_endpoint_matrix_generated.md
- Test evidence: Automated validation run RUN-2026-07-14-010; log: audits/test-evidence/010.md
