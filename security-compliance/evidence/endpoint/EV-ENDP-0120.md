# Endpoint Evidence - EV-ENDP-0120

- Evidence ID: EV-ENDP-0120
- Control ID: PRI-01
- Domain: Minimum Necessary / Data Minimization
- Artifact Name: Endpoint review evidence - GET /api/v1/incidents/dashboard-summary
...
## Endpoint
- Method/Path: GET /api/v1/incidents/dashboard-summary
...
- Source references: security-compliance/controls/endpoint-minimum-necessary-reviews.csv (EvidenceRef=EV-ENDP-0120); audit/tmp/_tmp_endpoint_matrix_generated.md
- Test evidence: Automated validation run RUN-2026-07-14-B5-043; log: audits/test-evidence/batch5/043.md
