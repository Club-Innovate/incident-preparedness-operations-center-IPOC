# Endpoint Evidence - EV-ENDP-0070

- Evidence ID: EV-ENDP-0070
- Control ID: PRI-01
- Domain: Minimum Necessary / Data Minimization
- Artifact Name: Endpoint review evidence - POST /api/v1/agent/analytics/events
...
## Endpoint
- Method/Path: POST /api/v1/agent/analytics/events
...
- Source references: security-compliance/controls/endpoint-minimum-necessary-reviews.csv (EvidenceRef=EV-ENDP-0070); audit/tmp/_tmp_endpoint_matrix_generated.md
- Test evidence: Automated validation run RUN-2026-07-14-B4-020; log: audits/test-evidence/batch4/020.md
