# Endpoint Evidence - EV-ENDP-0003

- Evidence ID: EV-ENDP-0003
- Control ID: PRI-01
- Domain: Minimum Necessary / Data Minimization
- Artifact Name: Endpoint review evidence - POST /api/v1/admin/streaming/upload
...
## Endpoint
- Method/Path: POST /api/v1/admin/streaming/upload
...
- Source references: security-compliance/controls/endpoint-minimum-necessary-reviews.csv (EvidenceRef=EV-ENDP-0003); audit/tmp/_tmp_endpoint_matrix_generated.md
- Test evidence: Automated validation run RUN-2026-07-14-003; log: audits/test-evidence/003.md
